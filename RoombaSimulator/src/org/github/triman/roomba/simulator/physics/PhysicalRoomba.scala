...
object PhysicalRoomba {	
	...
	val wall				= new Point2D.Double(0, 178)	// 10mm outside on the right, on the horizontal axis
	...
	val casterWheel = new Point2D.Double(175, 0)	// on the axis, 175mm from the center
	...
	val cliffRight = List(new Point2D.Double(150, 55), new Point2D.Double(-150, 55))
	val cliffLeft = List(new Point2D.Double(150, -55), new Point2D.Double(-150, -55))
